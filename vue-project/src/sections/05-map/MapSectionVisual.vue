...
import gtaFirmsTunaCsvRaw from '../../data/csv/GTA_FIRMs_tuna_cleaned_grouped.csv?raw'
import tunaCatchData5degUrl from '../../data/geojson/cwp-grid-5deg-catch-bluefin.geojson?url'
import iccatFishFarmsCentroidsUrl from '../../data/geojson/iccat_fish_farms_centroids.geojson?url'
